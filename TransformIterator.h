...
namespace lagy {
	...
	public:
		...
		{
			return lhs.m_wrappedIt == rhs.m_wrappedIt;
		}
		...
		[[nodiscard]]
		friend bool operator==(const TransformIterator& lhs, const WrappedIteratorType& rhs)
		{
			return lhs.m_wrappedIt == rhs;
		}
		...
		/// <return> True if the wrapped iterator is equal to the other iterator. False otherwise. </return>
		[[nodiscard]]
		friend bool operator==(const WrappedIteratorType& lhs, const TransformIterator& rhs)
		{
			return lhs == rhs.m_wrappedIt;
		}
